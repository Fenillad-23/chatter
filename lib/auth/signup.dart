...
class _SignUpState extends State<SignUp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:
          Appbar('Sign Up', AppColors.primaryText, true, AppColors.primaryIcon,true),
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                        ...
                        child: TextView('Please fill the details to sign up',
                            fontSize: 16, textColor: AppColors.lightText)),
                    Padding(
